  ...
  <div class="container">
    ...
    <div>
      <div v-for="(a, key) of lista_a_consumir" :key="key" class="input-group mb-3">
        ...
        <input type="text" class="form-control col-md-1" placeholder="Código" aria-label="Código" v-model="a.tCodigo"
          @keyup="FiltrarHerramienta(a)" @focus="a.bFocusCodigoODescripcion = true"
          @blur="a.bFocusCodigoODescripcion = false" />

        <input type="text" class="form-control col-md" style="width: 35%" placeholder="Descripción"
          aria-label="Descripción" v-model="a.tDescripcion" @keyup="FiltrarHerramienta(a)"
          @focus="a.bFocusCodigoODescripcion = true" @blur="a.bFocusCodigoODescripcion = false" />
        ...
        <span class="input-group-text col-md-1">Estado:</span>
        <select class="form-control col-md-1" v-model="a.estado">

          <option>PERDIDA</option>
          <option selected>CONSUMIDA</option>

        </select>
        <button v-if="lista_codigos_filtro.length == 0 && (a.tCodigo != '' || a.tDescripcion != '')"
          @click="AgregarHerramientaFaltante(a)" :class="'btn btn-' +
    ...
    <input-drop-down :prompt="'Legajo o Nombre'" :lista_completa="lista_operarios" ref="ref_operario" @onchange="(val) => {
      tNombre = val;
    }
      ">
    ...
    <div class="input-group mb-3">
      ...
      <textarea class="form-control" v-model="notaConsumo"></textarea>
    </div>
